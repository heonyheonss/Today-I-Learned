# -*- coding: utf-8 -*-
"""
Created on Sat Nov  4 21:46:15 2023
...
# %% Data
idx2word = ['<bos>', '<eos>', 'e', 'h', 'l', 'o']
word2idx = {word: i for i, word in enumerate(idx2word)}

seq = ['<bos>', 'h', 'e', 'l', 'l', 'o', '<eos>']
...
def accuracy_fn(Y, out):
    Y_chk = torch.argmax(Y, 2)
    out_chk = torch.argmax(out, 2)
